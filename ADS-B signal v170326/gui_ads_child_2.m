classdef gui_ads_child_2 < handle
%% *********************************************************************
%
% @file         gui_ads_child_2.m
...
% ******************************************************************************
    ...
    methods
        ...
        function obj = gui_ads_child_2(gui_m)
            ...
            obj.panel_width = 533;
            obj.panel_height = 310;
            
            % The first row info.
            % Create figure and init.
            obj.gui_p = figure('Color', [0.83, 0.82, 0.78], ...
                'Numbertitle', 'off', 'Name', '多飞行器场景仿真及ADS-B信号模拟程序', ...
            ...
            obj.config_auto = uicontrol('parent', obj.gui_p, ...
                ...
                'Fontsize', 12, 'position', [15, obj.gui_height - 105, 141, 40]);
            ...
            obj.plane_edt_vh = uicontrol('parent', obj.panel_plane, 'style', ...
                'edit', 'BackgroundColor','white' ...
              ,'Fontsize',11,'position',[361 obj.panel_height - 235 ...
              120 40]);
            ...
            obj.button_rcv = uicontrol('parent', obj.panel_rcv, ...
                ...
                'Fontsize', 11, 'position', [35, obj.panel_height - 290, 180, 40]);
            ...
            obj.ip_edt = uicontrol('parent', obj.gui_p, 'style', ...
              ...
              obj.panel_height - 210 140 50]);
            obj.ip_btn = uicontrol('parent', obj.gui_p, ...
                'style', 'pushbutton', 'BackgroundColor', ...
                [0.83, 0.82, 0.78], 'string', '网络连通测试', ...
                'Fontsize', 12, 'position', [700, obj.panel_height - 282, 120, 50]);
